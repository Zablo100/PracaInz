...
namespace pracaInż.Migrations.AppDbcontextMigrations
{
    ...
    [Migration("20231206133904_ZmianaDokumentów")]
    partial class ZmianaDokumentów
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("pracaInż.Models.Entities.Documents.DocumentModel", b =>
                {
                    ...
                    b.HasDiscriminator<string>("Discriminator").HasValue("DocumentModel");
            ...
            modelBuilder.Entity("pracaInż.Models.Entities.Documents.PurchaseOrderDoc", b =>
                {
                    b.HasBaseType("pracaInż.Models.Entities.Documents.DocumentModel");

                    b.HasDiscriminator().HasValue("PurchaseOrderDoc");
                });
